    ...
    <body>
        ...
        <div class="container card-set">
                    ...
                    <div class="card" >
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                ...
                                Price: 5,000 LKR<br />
                                Occupancy: 2 Adults, 2 Child<br /><br />
                                Air conditioned, one attached bathroom<br /><br />
                                Balcony and Swimming pool access
                            </p>
                            <div class="button-book"><a href="./../Reservations/reservations.jsp" class="btn btn-primary">Book Now</a></div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-6 rightcol">
                    <div class="card">
                        <img src="./../Images/header 2.jpg" class="card-img-top" alt="Card Image">
                        <div class="card-body">
                            <p class="card-text">
                                <span class="card-header-text">King Room</span><br /><br />
                                Price: 12,000 LKR<br />
                                Occupancy: 4 Adults, 4 Child<br /><br />
                                Air conditioned, one attached bathroom<br /><br />
                                Air conditioned, one attached bathroom<br />
                                Balcony and Swimming pool access
                            </p>
                            <div class="button-book"><a href="./../Reservations/reservations.jsp" class="btn btn-primary">Book Now</a></div>
                        </div>
