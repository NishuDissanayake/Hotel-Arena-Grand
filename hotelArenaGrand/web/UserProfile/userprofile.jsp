    ...
    <body>
        ...
        <div class="container form-1">
            ...
            <div class="row table-row">
                ...
                <div class="col-6 txt-col-2"><%=resultSet.getString("fullname")%></div>
            </div>
            <div class="row table-row">
                <div class="col-6 txt-col-1">Email</div>
                <div class="col-6 txt-col-2"><%=resultSet.getString("email")%></div>
            </div>
            <div class="row table-row">
                <div class="col-6 txt-col-1">Telephone</div>
                <div class="col-6 txt-col-2"><%=resultSet.getString("phone")%></div>
            </div>
            <%
                           } 
                            connection.close();
