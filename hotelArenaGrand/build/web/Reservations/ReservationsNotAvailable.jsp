...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./ReservationsNotAvailable.css" />
                <!--<link rel="stylesheet" href="./Reservations/ReservationsNotAvailable.css" />-->
    ...
    <body>
        ...
        <div class="container reserveAvailable">
            ...
            <p class="reserve-content">
                The room you have requested is not available. please make an<br/>
            ...
            <img class="sorry" src="<%= request.getContextPath()%>/../Images/sorry.jpg"/>
            
            <div class="input_field">
                <input type="submit" value="Go Back" class="btn" onclick="window.location.href='./reservations.jsp';">
            </div>
        </div>
