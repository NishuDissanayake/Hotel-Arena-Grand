<%-- 
    Document   : footer
    Created on : Dec 26, 2021, 9:06:21 PM
    Author     : HP
--%>
            ...
            <div class="row">
                <div class="col-4">
                    <div class="row img-footer">
                        <img src="./Images/ArenaGrand Logo.png" alt="logo" />
                    </div>
                    <div class="row">
                        <p>
                ...
                <div class="col-8 footer-form">
                    ...
                    <form>
                        ...
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputPassword" placeholder="Full Name">
                        </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-4 col-form-label">Phone Number</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputPassword" placeholder="07X-XXXXXXX">
                        </div>
                        </div>
                        <div class="form-group row">
